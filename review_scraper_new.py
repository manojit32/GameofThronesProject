...
def do_stuff():
    for p2 in xrange(0, 2):
        url1 = 'http://www.imdb.com/title/tt1480055/reviews?start='
        url = url1 + str(p2*10)
        ...
        with open(out_file, 'a') as f:
            for review in whole_review_block.find_all('p')[: -1]:
                ...
                print
                f.write(cleaned_review.encode('utf-8'))
    ...
    for i, blob in enumerate(bloblist):
        ...
        out_filename = 's01e01_tf_idf_full.txt'
        st = '\n\nReview {}\nWord\tTF-IDF\n'.format(i)
